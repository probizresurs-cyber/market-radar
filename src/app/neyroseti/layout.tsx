...
// Адрес латиницей намеренно. Диктуется он одинаково — «слэш нейросети»
// произносится по-русски в любом случае, — а вот копируется по-разному:
// кириллический путь превращается в /%D0%BD%D0%B5%D0%B9... везде, где
// ссылку вставляют в переписку, КП, CRM или отчёт. Плюс Next 16 падает
// с InvalidCharacterError на кириллическом сегменте маршрута — это
// выяснилось на сборке. Кириллический /нейросети оставлен редиректом
// для тех, кто наберёт адрес по-русски.
const PATH = "/neyroseti";
...
export const metadata: Metadata = {
  ...
  description:
    ...
    "Бесплатная проверка покажет, находят ли вас в поиске и называют ли нейросети; дальше " +

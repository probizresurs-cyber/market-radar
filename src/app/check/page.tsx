      ...
      <section className="mrc-slab mrc-hero">
        <div className="mrc-wrap">
          <header className="mrc-topbar">
            ...
            <span className="mrc-mono mrc-topbar-tag">SEO и GEO · замер 0 ₽</span>
          </header>
          ...
          <div className="mrc-hero-grid">
            <div className="mrc-hero-head">
              ...
              <p className="mrc-lead mrc-hero-lead">
                ...
                Начинаем с бесплатного замера: покажем, на каком уровне ваш сайт по SEO и GEO
                сейчас и что мешает вас находить.
              </p>
            </div>
      ...
      <div className="mrc-wrap">
        ...
        {!checkId && (
          <ol className="mrc-route" aria-label="Как это работает">
            ...
            {[
              ["Замер", "Вводите адрес — считаем три показателя и показываем, на каком уровне сайт по SEO и GEO сейчас. Бесплатно, без регистрации."],

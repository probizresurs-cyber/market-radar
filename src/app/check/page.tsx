  ...
  return (
    <div className="mrc-root">
      ...
      <div className="mrc-wrap">
        ...
        {/* ─── 05 · Обещания, которых не бывает ─── */}
        <section className="mrc-sec" data-reveal>
          <SecHead
            idx="05"
            title="Обещания, которых не бывает"
            sub="Три фразы, которые чаще всего слышат от подрядчиков. Разбираем, почему ни одна из них невыполнима — и что стоит за ней на самом деле."
          />

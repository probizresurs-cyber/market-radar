...
3. brollQueries — 3-4 английские короткие фразы (2-5 слов каждая) — сцены, которыми AI-видеогенератор проиллюстрирует ролик. Конкретные, предметные (например "dentist examining patient", "musician recording session"), НЕ абстрактные ("business success").
   ...
   ЛЮДИ НА ВЫСОТЕ — ЗАПРЕТ: не заказывай сцены, где человек лезет, стоит на конструкции, работает на высоте, на лесах, на лестнице, на балке. Модель рисует человека, но забывает приделать его к опоре — на живом ролике рабочий висел в воздухе у металлокаркаса, и весь ролик выглядел подделкой. Человек в кадре — только стоя на земле, спокойно. Ещё надёжнее: показывай конструкции и материалы БЕЗ людей.

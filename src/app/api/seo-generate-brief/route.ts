...
КРИТИЧЕСКИ ВАЖНО: верни ТОЛЬКО валидный JSON без какого-либо текста до или после. Не оборачивай в markdown-блоки. В строковых значениях не используй двойные кавычки — только одинарные или перефразируй. Структура:
{
...
Для wordCountTarget ориентируйся на тип: informational=2000-3000, how-to=1500-2500, listicle=2000-4000, review=2500-4000, comparison=2000-3500, case-study=1500-2500, faq=1500-3000, landing-article=1200-2000.`;
    ...
    if (!data) {
      console.error("[seo-brief] raw response (first 1000 chars):", rawText.slice(0, 1000));

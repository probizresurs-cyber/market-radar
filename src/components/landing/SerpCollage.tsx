...
const NICHES: Niche[] = [
  {
    ...
    rows: [
      ...
      { title: "натяжные потолки недорого, замер бесплатно", mark: "Компания Б", url: "company-b.ru › potolki", rate: "4,6 · 41 отзыв", snip: "Цены от 450 ₽/м². Монтаж за один день, выезд мастера бесплатно." },

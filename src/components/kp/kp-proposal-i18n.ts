...
export const KP_PROPOSAL_I18N: Record<KpProposalLocale, KpProposalStrings> = {
  ru: {
    ...
    deeperTitle: "Что разберём глубже перед продвижением",
    deeperSubtitle: "Этот документ — то, что видно снаружи и требует срочного решения. Работа начинается с глубокого разбора, включая SEO и GEO, и только после него идёт само продвижение.",
    lhPassport: "Замер:",
  ...
  de: {
    ...
    deeperTitle: "Was wir vor der Umsetzung tiefer prüfen",
    deeperSubtitle: "Dieses Dokument zeigt, was von außen sichtbar ist. Die Arbeit beginnt mit einer tiefen Analyse — auch zu SEO und GEO — und erst danach folgt die Umsetzung selbst.",
    lhPassport: "Messung:",

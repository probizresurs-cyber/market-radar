...
Анализируй ПЕРСОНУ, не компанию.
...
- Scores интерпретируй для личного бренда:
  * seo = диджитал-присутствие (можно ли найти персону онлайн)
  * social = личная активность в соцсетях
  * content = качество/системность контента персоны
  * hrBrand = авторитет и экспертный вес в нише
  * technology = цифровые инструменты и платформы
...
- practicalAdvice.offerAnalysis → личное УТП и позиционирование персоны.
- practicalAdvice.contentIdeas → 4 идеи контента конкретно для личного бренда.
- practicalAdvice.copyImprovements → улучшения bio, описания в соцсетях, персональный оффер.
...
- ровно 5 associatedKeywords в aiPerception`;
  ...
  const categories: CategoryScore[] = [
    { name: "Присутствие", weight: 25, score: scores.seo, icon: "🌐", delta: 0 },
    { name: "Соцсети", weight: 25, score: scores.social, icon: "📱", delta: 0 },
    { name: "Контент", weight: 20, score: scores.content, icon: "✏️", delta: 0 },
    { name: "Авторитет", weight: 15, score: scores.hrBrand, icon: "⭐", delta: 0 },
    { name: "Инструменты", weight: 15, score: scores.technology, icon: "⚙️", delta: 0 },
  ];
